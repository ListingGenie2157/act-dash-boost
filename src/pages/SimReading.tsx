        ...
        <div className="max-w-4xl mx-auto">
          <div className="print-content bg-white text-black p-8 rounded-lg shadow-lg">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold mb-2">ACT Reading Simulation Results</h1>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">ACT Reading Simulation</h1>
      ...
      <div className="max-w-7xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-5 gap-6">
        {/* Question Navigation */}
        ...
        {currentQ?.passage_text && (
          <div className="lg:col-span-2">
            <Card className="h-full">
              <CardHeader>
                <CardTitle>{currentQ.passage_title || 'Reading Passage'}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="prose max-w-none text-sm leading-relaxed overflow-y-auto max-h-96">
                  <p className="whitespace-pre-wrap">{currentQ.passage_text}</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        {/* Current Question */}
        <div className={`${currentQ?.passage_text ? 'lg:col-span-2' : 'lg:col-span-4'}`}>
          {currentQ && (
            <Card>
              <CardHeader>
