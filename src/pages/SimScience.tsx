        ...
        <div className="max-w-4xl mx-auto">
          <div className="print-content bg-white text-black p-8 rounded-lg shadow-lg">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold mb-2">ACT Science Simulation Results</h1>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">ACT Science Simulation</h1>
        ...
        {currentQ?.passage_text && (
          <div className="lg:col-span-2">
            <Card className="h-full">
              <CardHeader>
                <CardTitle>{currentQ.passage_title || 'Science Passage'}</CardTitle>
              </CardHeader>
              <CardContent>
