...
import type { Day, DrillSession, QuizAnswers } from '@/types';
...
interface DayViewProps {
  ...
  onUpdateScore: (lessonId: string, practiceScore: number, quizScore: number, wrongAnswers: QuizAnswers) => void;
}
...
export const DayView = ({ day, onBack, onDayComplete, onUpdateScore }: DayViewProps) => {
  ...
  const handleLessonComplete = (lessonId: string, practiceScore: number, quizScore: number, wrongAnswers: QuizAnswers) => {
